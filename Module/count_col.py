...
def scaling_fit(data, Rf, V, H, Zipf, name, SP, FORMAT):
    ...
    Zipf: tuple (c, s), where C is the leading coffecient and s is the exponent of frequency-rank distribution of word        
    ------output
    ...
    for fn in data:
        if fn != 'f1':           
            ...
            popt, pcov = curve_fit(fun, data[fn][0], data[fn][1], q0, bounds =(0, [np.inf, 1.5]))
